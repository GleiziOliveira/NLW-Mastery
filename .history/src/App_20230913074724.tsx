        ...
        <aside className="w-80 space-y-6">
          ...
          <form className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <span className=" block text-sm text-muted-foreground italic leading">
                Valores mais altos tendem a deixar o resultado mais criativo, porém a tendência é que de tenha mais erros.
              </span>
            </div>
          </form>
        </aside>
